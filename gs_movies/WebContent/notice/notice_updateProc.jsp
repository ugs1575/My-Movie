...
<body>
  ...
  <div class="container">
  <%if(flag){%>
     <h2>Notice 게시판 글 수정이 완료되었습니다. 감사합니다.</h2>
     <%}else{%>
     <h2>Notice 게시판 글 수정이 실패하였습니다. 다시 한번 시도해주세요.</h2>
  	 <%} %>
    ...
    <div>
    <%if(flag==false){ %>
      <button type="button" id="againbtn" onclick="location.href='loginForm.jsp'">Login</button>
       	<%} %>
