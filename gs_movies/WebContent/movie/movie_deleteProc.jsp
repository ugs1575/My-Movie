...
out.println("<br><br><button type='button' onclick=\"modal01.style.display=\'none\'\" style='width:50px; height:30px; background-color:transparent; border:1px solid white;'>확인</button>");
out.println("삭제를 성공했습니다.</div>");
}else{
/* content */
out.println("<div style='width:300px; height:330px; margin-left:auto; margin-right:auto; margin-top:200px; margin-bottom:50px; border:1px solid white; color:white; text-align:center; padding: 120px 0;'>");
out.println("<br><br><button type='button' onclick=\"modal01.style.display=\'none\'\" style='width:50px; height:30px; background-color:transparent; border:1px solid white;'>확인</button>");
out.println("삭제를 실패했습니다.</div>");
};
