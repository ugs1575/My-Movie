...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>Movie</b></span><br> <span class="w3-hide-small w3-text-light-grey">Introduction & brief story of Movie</span></h1>
  </div>
</header>
...
<body>
  ...
  <div class="container">
  <%if(flag){%>
     <h2>Movies 게시판 새 글 등록이 완료되었습니다. 감사합니다.</h2>
     <%}else{%>
     <h2>Movies 게시판 새 글 등록이 실패하였습니다. 다시 한번 시도해주세요.</h2>
  	 <%} %>
    ...
    <%if(flag==false){ %>
     ...
     <%} %>
      <button type="button" id="homebtn" onclick="location.href='movie_list.jsp'" style="float:right">Movie 목록</button>
    </div>
  </div>
