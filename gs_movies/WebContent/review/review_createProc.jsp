...
<body>
  ...
  <%if(flag){%>
     <h1>Reviews 게시판 새 글 등록이 완료되었습니다. 감사합니다.</h1>
     <%}else{%>
     <h1>Reviews 게시판 새 글 등록이 실패하였습니다. 다시 한번 시도해주세요.</h1>
  	 <%} %>
    ...
    <div class="clearfix">
      ...
      <button type="button" class="homebtn" onclick="location.href='review_list.jsp'">Review list</button>
    </div>
  </div>
